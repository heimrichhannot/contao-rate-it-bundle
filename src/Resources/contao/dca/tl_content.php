...
$GLOBALS['TL_DCA']['tl_content']['config']['onsubmit_callback'][] = ['tl_content_rateit', 'insert'];
$GLOBALS['TL_DCA']['tl_content']['config']['ondelete_callback'][] = ['tl_content_rateit', 'delete'];
 ...
 */
class tl_content_rateit extends \HeimrichHannot\RateItBundle\DcaHelper
{
    /**
     * Constructor
     */
